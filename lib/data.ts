    ...
    projects: [
        {
            slug: "santehnik-site",
            category: "Website",
            title: "E-commerce проект «SantehKharkiv»",
            description: "Функциональный интернет-магазин сантехники и отопительного оборудования, ориентированный на удобство выбора товаров и информирование клиентов. Реализована четкая структура каталога и система навигации для быстрого доступа к продукции и услугам.",
            fullDescription: "Сайт представляет собой цифровую витрину для магазина сантехники в Харькове. Интерфейс включает в себя динамический каталог с разделением на ключевые категории (Сантехника, Отопление, Трубы, Мебель) и поддержку поиска по брендам (например, GROHE). Реализованы информационные страницы для клиентов (Доставка, Гарантия, Услуги), раздел контактов с интерактивной картой (подразумевается) и функционал личного кабинета пользователя.",
            tags: ["Next.js"],
            links: { demo: "https://my-portfolio-14-19jz.vercel.app/", repo: "https://github.com/onSophia/my-portfolio-14/blob/main/app/page.tsx" },
            challenge: "Разработка логики фильтрации товаров через query-параметры (категоризация по URL) и реализации поиска. Организация структуры многостраничного приложения с динамической подгрузкой контента (Loading states) и маршрутизацией для информационных разделов и профиля пользователя.",
            image: "/project-site9.jpg"
        },
        {
            slug: "sofa-site",
            category: "Website",
